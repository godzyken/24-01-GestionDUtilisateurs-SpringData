...
mvn clean install ^
 -e -X ^
 > .\logCompile\compile--GestionDUtilisateurs-04--%date:~6,4%.%date:~3,2%.%date:~0,2%--0%time:~1,1%.%time:~3,2%.%time:~6,2%.log
 
mvn clean install ^
 -e -X ^
 > .\logCompile\compile--GestionDUtilisateurs-04--%date:~6,4%.%date:~3,2%.%date:~0,2%--%time:~0,2%.%time:~3,2%.%time:~6,2%.log
 
mvn clean install ^
 -e -X ^
 > .\logCompile\compile--GestionDUtilisateurs-04.log
